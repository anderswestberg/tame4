...
class TAME {
    constructor(service) {
        ...
        this.writeStruct = (args) => __awaiter(this, void 0, void 0, function* () { return yield this.writeAccessStruct('Write', args); });
        this.readStruct = (args) => __awaiter(this, void 0, void 0, function* () { return yield this.readAccessStruct('Read', args); });
    ...
    parseReadReq(adsReq, response) {
        let itemList = adsReq.reqDescr.items, arrType = [], strAddr = 0, item, dataString, dataSubString, strlen, len, plen, mod, type, format, idx, listlen, startaddr;
        let result;
        try {
    ...
    parseSumReadReq(adsReq, response) {
        var itemList = adsReq.reqDescr.items, arrType = [], strAddr = 0, subStrAddr = 0, dataObj = window, vlenMax = 0, item, dataString, dataSubString, data, len, type, format, idx, listlen, errorCode, jvar, i, arrayLength, itemSize, itemInfo;
        /**
    ...
    parseSumWriteReq(adsReq, response) {
        var itemList = adsReq.reqDescr.items, arrType = [], arrDeletedHdl = [], strAddr = 0, subStrAddr = 0, dataObj = window, item, dataString, dataSubString, data, len, type, format, idx, listlen, errorCode, delIdx, symName;
    ...
    parseUpload(adsReq, response) {
        var strAddr = 0, igOffs = 4, ioOffs = 8, sizeOffs = 12, nameOffs = 30, dataString, dataSubString, data, cnt, infoLen, nameAndType, typeArr, arrayLength, type, elem;
        try {
            dataString = this.decodeBase64(response.getElementsByTagName('ppData')[0].firstChild.data);
    ...
    */
    getConfigFile() {
        return __awaiter(this, void 0, void 0, function* () {
            var symbolArray = [], name, allSymbols, typeArr, arrayLength, type, elem, tcVersion, i;
            ...
            if (this.service.serviceUser || this.service.servicePassword)
                options.headers.push(['Authorization', 'Basic ' + btoa(this.service.serviceUser + ":" + this.service.servicePassword)]);
            let response = yield fetch(this.service.configFileUrl, options);
            let str = yield response.text();
            const configFile = new window.DOMParser().parseFromString(str, "text/xml");
